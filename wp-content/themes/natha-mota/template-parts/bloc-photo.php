...
<div class="blockPhotoRelative">
    ...
    <div class="overlay">
        ...
        <?php if ($reference) : ?>
            <div class="fullscreen-icon" data-full="<?php echo esc_attr($photoUrl); ?>" data-category="<?php echo esc_attr($categorie_name); ?>" data-reference="<?php echo esc_attr($reference); ?>"> <!-- on associe les references a l'icone fullscreen pour la recuperer en js -->
